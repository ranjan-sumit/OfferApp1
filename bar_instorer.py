...
if st.button('Login') and (input_value_shareid or input_value_emailid or input_value_phoneno) and error_flag:
    with st.spinner("Your offer is being prepared. Kindly hold on!"):
        offer = None
        if input_value_shareid:
            offer = "5% cashback on shop of 200 AED Instore Shopping + Free Meal of the Day - Breakfast/Lunch/Dinner "
        elif input_value_emailid:
            offer = "5% cashback on shop of 200 AED Instore Shopping + Free Meal of the Day - Breakfast/Lunch/Dinner "
        elif input_value_phoneno:
            if input_value_phoneno == "819719934":
                login_flag = True
                selected_offer = "5% cashback on shop of 200 AED Instore Shopping + Free Meal of the Day - Breakfast/Lunch/Dinner "
            else:
                login_flag = False
        ...
        if login_flag:
            ...
            selected_offer_new_cust = "Get Flat 5% cashback on spend up to 150 AED on your first purchase +  Free Meal of the Day - Brekfast/Lunch/Dinner "
            offer_html_new = f"""
            <style>
            @keyframes fadeIn {{
                0% {{opacity: 0;}}
