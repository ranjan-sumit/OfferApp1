    ...
    with st.spinner("Your offer is being prepared. Kindly hold on!"):
        ...
        if input_value_shareid:
            ...
            if input_value_phoneno == "819719934":
                login_flag = True
                selected_offer = "10% cashback on shop of 200 AED both Online and Instore Shopping"
            else:
                login_flag = False
        ...
        if login_flag:
            ...
            selected_offer_new_cust = "Get Flat 10% Off up to 150 AED on your first purchase."
            offer_html_new = f"""
            <style>
            @keyframes fadeIn {{
                0% {{opacity: 0;}}
